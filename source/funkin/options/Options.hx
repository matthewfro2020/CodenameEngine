...
class Options
{
	...
	public static var practiceLastSong:String = null;
	public static var practiceLastDifficulty:String = "normal";
	/**
	 * Whether the player bot (auto-play) is enabled during songs.
	 */
